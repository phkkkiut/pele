      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/alexawya",
                   'caption'=>'My Ch : @alexawya',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب ☃️','callback_data'=>'login']],
                       [['text'=>"Dev", 'url'=>"https://t.me/OS74O"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'video'=>"https://t.me/YYYYYJUY",
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/OS74O"]],
                       ]
                       ])
                       ]);
    
              $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/alexawya",
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"control panal ✔️✔️~ @YYYYYJUY",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب ☃️👨🏻‍💻','callback_data'=>'login']],
          ...
          if($data == 'login'){
            ...
            exec('screen -dmS gr php explore.php');
          	...
          	$bot->editMessageText([
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                     'text'=>"control panal ✔️✔️~ @alexawya",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب ☃️👨🏻‍💻','callback_data'=>'login']],
                          [['text'=>'طرق السحب ☄️☄️','callback_data'=>'grabber']],
